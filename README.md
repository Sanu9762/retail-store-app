# Retail Store Sample Application - GitOps with Amazon EKS Auto Mode .
...
[![Stars](https://img.shields.io/github/stars/Sanu9762/retail-store-sample-app)](Stars)
![GitHub License](https://img.shields.io/github/license/Sanu9762/retail-store-sample-app?color=green)
...
- [Cleanup](https://github.com/Sanu9762/retail-store-sample-app/blob/main/README.md#step-12-cleanup)
...
3. **Clone Repository**: `git clone https://github.com/Sanu9762/retail-store-sample-app.git`
...
```sh
git clone https://github.com/Sanu9762/retail-store-sample-app.git
```
...
- **Issues**: [GitHub Issues](https://github.com/Sanu9762/retail-store-sample-app/issues)
